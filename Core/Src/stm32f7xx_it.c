...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
volatile int currentN = 0; //where are we in terms of the array
volatile int currentSeqIndex = 0;
/* USER CODE END PV */
...
/* USER CODE BEGIN EV */
extern volatile int prevButton;
extern const int n;
extern volatile int seq[256];
extern volatile int currentRGB;
extern int RGB[3];
/* USER CODE END EV */
